...
# LLM利用排序直接预测
AGENT_PREDICT_INSTRUCTION = """Given clinical features of patient, estimate whether the patient has the diabetes or not and explain your reasoning. You will be provided a feature importance ordering, which you can refer to. Give your response in this format:
(1) Disease Prediction, which should be either "no diabetes" or "diabetes".
(2) Explanation, which should be in a single, short paragraph.
Here are some examples:
{examples}
...
O3_PREDICT_INSTRUCTION = """Given clinical features of a group of patients, estimate whether the patient has the diabetes or not and explain your reasoning seperately. For each patient, Give your response in this format:
ID: xxx, which should be the sample id.
Disease Prediction: xxx, which should be either "no diabetes" or "diabetes". No other options, no "low/medium/high diabetes".
...
O3_ORDER_PREDICT_INSTRUCTION = """Given clinical features of a group of patients, estimate whether the patient has the diabetes or not and explain your reasoning seperately.  You will be provided a feature importance ordering, which you can refer to. For each patient, Give your response in this format:
ID: xxx, which should be the sample id.
Disease Prediction: xxx, which should be either "no diabetes" or "diabetes". No other options, no "low/medium/high diabetes".
Explanation: xxx, which should be in a single, short paragraph.
Here are some examples:
